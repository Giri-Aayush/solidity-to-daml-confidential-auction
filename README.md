...
[![tests](https://img.shields.io/badge/tests-16_Foundry_%2B_8_Daml-2ea043?style=flat-square)](#run-it)
...
make test     # both suites: Solidity (16) + Daml (8), the same thing CI runs
