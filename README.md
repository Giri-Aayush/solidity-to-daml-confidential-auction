...
|---|---|---|
| [`solidity/`](solidity/) | First-price sealed-bid auction via commit/reveal, with Foundry tests | ✅ 8/8 tests pass |
| [`daml/`](daml/) | The same auction in Daml, private by construction, with Daml Script tests | ✅ 3/3 scripts pass |
...
```bash
# EVM reference — 8 Foundry tests
cd solidity && forge test -vv

# Canton/Daml version — 3 Daml Script tests, including the privacy proof
cd daml && daml test
```
